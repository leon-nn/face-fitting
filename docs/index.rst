...
Other low-level features that should be implemented are outlined in :doc:`missing`.

Prerequisites
=============

* Python 3
* Packages: PyOpenGL, numpy, scipy, librosa, scikit-learn, scikit-image, mayavi
...
4. Install via `pip` with the `--editable` or `-e` flag: `pip install -e .`.
